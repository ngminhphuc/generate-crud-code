...
//        String serviceName = entityClasses.getServiceClass().getName();
        ...
        StringBuilder var10000 = content.append("private final ")
		        ...
		        .append("public List<")
		        .append(entityClasses.getEntityClass().getName())
		        .append("> findAll() { return (List<" + entityClasses.getEntityClass().getName() + ">) repository.findAll(); }")
		        .append("public Page<").append(entityClasses.getEntityClass().getName()).append("> findAll(Pageable pageable) {")
